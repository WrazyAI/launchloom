...
const payload = { repo: "WrazyAI/example", pr: 3, headSha: "abc123", siteId: "site-id", clientEmail: "client@example.com", allowedOrigins: ["https://example.pages.dev"], expiresAt: Date.now() + 60_000 };
