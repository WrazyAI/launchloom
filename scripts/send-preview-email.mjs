...
const html = deliveryFailure
  ...
  : developer
    ? `<p>Hi David,</p><p>A ${kind === "revision" ? "revised" : "new"} website preview for <strong>${clientName}</strong> is ready for internal review.</p>${clientFeedback ? `<hr><p><strong>Client feedback addressed in this revision</strong></p><blockquote style="margin:0;padding:12px 16px;border-left:3px solid #205d51;background:#f3f6f2;color:#24352e">${escapeHtml(clientFeedback)}</blockquote><p>This is the feedback that informed the preview below.</p>` : ""}<p><a href="${reviewUrl}">Open developer preview</a></p><p>Approve it to publish and invite the client, or leave feedback for another revision.</p><p>— LaunchLoom</p>`
