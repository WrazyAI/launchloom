...
function authorRules() {
  return [
    ...
    "Expose Services, FAQs, and Contact navigation. Keep the required primary action at its Reference DNA conversion location; do not force it into the hero when the reference places it later.",
    ...
    "Mark the complete reference-defined opening sequence with data-hero. Keep the primary H1 and exactly one functional data-early-conversion action within that measured opening sequence, but place the action at Reference DNA ctaPlacement.primary instead of forcing it beside the H1. When that location is a later first-screen feature rail, the data-hero wrapper may include those opening semantic sections through the rail. Do not put data-hero on the navigation alone. Retain ordered data-reference-section markers on semantic children. Keep Services, FAQs, and Contact sections outside the measured opening region unless Reference DNA explicitly defines them within it.",
